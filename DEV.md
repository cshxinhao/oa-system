...
- **审批路由**：自动指向申请人的部门负责人；若申请人本人是部门负责人，则路由到上级部门负责人
- **审批历史**：列表页三个 Tab（我的申请 / 待审批 / 审批历史）
...
User ──┬── LeaveApplication (applicant / reviewer)
...
请假和报销都采用「部门负责人 → 上级部门负责人」的层级路由规则，避免了硬编码审批人。对于小规模组织（2–3 层部门）非常适用。
